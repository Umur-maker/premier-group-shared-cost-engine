...
TRANSLATIONS = {
    "en": {
        ...
        "electricity_ron": "Electricity (RON)",
        "water_ron": "Water (RON)",
        "garbage_ron": "Garbage (RON)",
        "hotel_gas_ron": "Hotel Gas (RON)",
        "ground_floor_gas_ron": "Ground Floor Gas (RON)",
        "first_floor_gas_ron": "First Floor Gas (RON)",
    ...
    "ro": {
        ...
        "electricity_ron": "Electricitate (RON)",
        "water_ron": "Apa (RON)",
        "garbage_ron": "Gunoi (RON)",
        "hotel_gas_ron": "Gaz Hotel (RON)",
        "ground_floor_gas_ron": "Gaz Parter (RON)",
        "first_floor_gas_ron": "Gaz Etaj 1 (RON)",
